...
class UsersApi(object):
    ...
    def put_user(self, body, user_id, **kwargs):  # noqa: E501
        """put_user  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.put_user(body, user_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.put_user_with_http_info(body, user_id, **kwargs)  # noqa: E501
        else:
            (data) = self.put_user_with_http_info(body, user_id, **kwargs)  # noqa: E501
            return data

    def put_user_with_http_info(self, body, user_id, **kwargs):  # noqa: E501
        """put_user  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.put_user_with_http_info(body, user_id, async_req=True)
        >>> result = thread.get()
        ...
        if ('user_id' not in params or
                params['user_id'] is None):
            raise ValueError("Missing the required parameter `user_id` when calling `put_user`")  # noqa: E501
